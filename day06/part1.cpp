...
{   
    ...
    auto time_view = input_lines[0] | std::views::drop_while([](char c){return !std::isdigit(c);});
    auto distance_view = input_lines[1] | std::views::drop_while([](char c){return !std::isdigit(c);});
